...
export const projects: Project[] = [
  ...
  },
  {
    ...
    outcome:
      "Simulation framework and degradation results complete. Paper submitted to Optica for review — targets cs.GR / eess.IV if accepted. Next experiment: gradient-descent phase retrieval with PyTorch autograd, benchmarked against Gerchberg-Saxton.",
